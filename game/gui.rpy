...
# -- Cor de texto de titulo (h1, h2, h3, etc) --
define gui.accent_color = '#FFC500' 

## The color used for a text button when it is neither selected nor hovered.
# -- Cor de botao em estado neutro --
define gui.idle_color = '#B6B6B6'

## The small color is used for small text, which needs to be brighter/darker to
## achieve the same effect.
# -- Cor dos butao pininim
define gui.idle_small_color = '#6D6C6C'

## The color that is used for buttons and bars that are hovered.
# -- Cor de um botao quando passa o mouse em cima
define gui.hover_color = '#CFB351'
...
## -- Cor de botao que nao pode ser selecionado
...
define gui.text_color = '#030303' # -- cor do texto dialogo
define gui.interface_text_color = '#FFFFFF' # -- cor do texto nos pop-ups
